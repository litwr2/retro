...
text db "3..  2..  1..  START", 1, " HAPPY NEW YEAR!  THIS IS MY 1ST PROGRAM FOR THE ", 2, "+4 THAT PLAYS MUSIC.  THE TUNE IS TAKEN FROM THE OLD GOOD GAME HUSTLER.  I ALSO USED A FREE, ANONYMOUS ANIMATED GIF FROM THE NET AS THE BASIS FOR THE PICTURE.  WE CAN SEE PEOPLE RUNNING, BUT NO ONE ACTUALLY MOVES!  IT'S AN ILLUSION.  PERHAPS THE WORLD AROUND US IS AN ILLUSION TOO...  AND ALL OUR ACTIONS ARE NOTHING BUT VANITY OF VANITIES.  IT'S CRAZY AND AMAZING SIMULTANEOUSLY.  SO LET'S HAVE SOME MORE FUN!  ",0
