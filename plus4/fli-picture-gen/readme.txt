...
tobasic - return to Basic, after the call this function you can call functions to print characters or check the keyboard status.  The actual return to Basic happens when the RTS instruction will be executed, for instance
...
The 50/60 Hz timer is available on locations $d4-$d5, $d5 is the low byte.  The frequency is set by the PAL or NTSC hardware.
