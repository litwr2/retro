...
65 printspc(5);:printusing"distorts about ##.##% of the raster";(a+b)*50/39
70 print"proceed?(y/n)":getkeya$:ifa$="n"goto40:else:ifa$<>"y"goto70
80 print"where put the code:":print"1 @$332 (cassette buffer)"
90 print"2 @$1000 (no graphics)"
100 print"3 @$1000 (graphics on)"
110 inputc:ifc<1orc>3then80
120 print"do not use split screen modes!"
130 poke8192,a:poke8193,b:poke8194,c-1:clr:sys1111
