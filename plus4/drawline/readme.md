...
Perhaps they are the fastest routines for drawing lines for the 6502 and Commodore bitmap graphics.  They require approximately 210(hr)/220 (mc) CPU cycles per pixel.  This delivers approximately 5460(hr)/5130(mc) pixels per second on the C+4.  It is doubtful that routines faster than 5% are possible for this task.  There have been programs that use algos with similar performance.
